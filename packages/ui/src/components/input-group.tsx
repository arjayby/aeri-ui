...
import { Input } from "@aeri-ui/ui/components/input";
import { Textarea } from "@aeri-ui/ui/components/textarea";
...
function focusInputGroupControl(element: HTMLElement) {
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: The addon can contain buttons, so a button element would create invalid nested controls.
		<div
			role="button"
			tabIndex={0}
